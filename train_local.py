...
duration_secs = librosa.get_duration(filename='D:/diff-wave-synth/violin/valid/audio/II.+Double.wav')
print("""
======================
sr: {}
block_size: {}
...
train_lr: {}
======================
""".format(sr, block_size, int(duration_secs), batch_size, scales, overlap,
...
duration_secs = librosa.get_duration(filename='D:/diff-wave-synth/violin/valid/audio/II.+Double.wav')
y, pitch, loudness = preprocess("D:/diff-wave-synth/violin/valid/audio/II.+Double.wav", sr, block_size, sr * int(duration_secs))
y = torch.tensor(y)
