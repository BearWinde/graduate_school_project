...
def wfir(x: numpy.ndarray, fs: float, order: int) -> numpy.ndarray:
    ...
    yy[0] = lfilter(tensor_x,tensor_a,tensor_b, False)
    for i in range(1, len(ys)):
        ys[i] = scipy.signal.lfilter(B, A, ys[i - 1])
    for i in range(1, len(yy)):
        yy[i] = scipy.signal.lfilter(yy[i - 1], tensor_a, tensor_b,False)
...
encode_inputfile = "C:/Users/wenzo/Desktop/porject/ddsp_pytorch_wenzo/data/violin/test/marg_singing_voice.wav"
encode_outputfile = "C:/Users/wenzo/Desktop/porject/ddsp_pytorch_wenzo/marg_singing_voice_test_reverb.wlp.flac"
decode_outputfile = "C:/Users/wenzo/Desktop/porject/ddsp_pytorch_wenzo/marg_singing_voice_test_reverb_wlpc.wav"
wlpac_encode(encode_inputfile, encode_outputfile, container="flac")
wlpac_decode(encode_outputfile, decode_outputfile)
wlpac_compare(encode_inputfile,decode_outputfile)
